        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <form class="needs-validation" action="{{route('sliderStore')}}" novalidate method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6" style="margin-top: 2.5%">
                                ...
                                <div class="invalid-feedback">Please choose image for Slider</div>
                                @if ($errors->has('image'))
                                    <div class="alert alert-danger">
