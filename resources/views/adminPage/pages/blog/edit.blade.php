                        ...
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    @endif
{{--                                    {{dd($blogDetail)}}--}}
                                    <form class="needs-validation" id="blog" novalidate action="{{ route('admin.blog.edit.post',[$blogDetail->id_blog]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="name">Title</label>
                                                <input type="text" class="form-control" id="title" name="title" value="{{$blogDetail->title}}" required>
{{--                                                {{dd($blogDetail->title)}}--}}
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="description" name="description" value="{{$blogDetail->description}}" required>
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" id="true" name="active" value="1" required="" {{$blogDetail->active == 1 ? "checked" : ""}}>
                                                            <label class="custom-control-label" for="true">True</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input type="radio" class="custom-control-input" id="false" name="active" value="0" required="" {{$blogDetail->active == 0 ? "checked" : ""}}>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="example-fileinput" class="d-block">Add thumbnail for blog</label>
                                                <img class="w-50 h-auto mb-3" src={{$blogDetail->avatar}} alt="avatar">
                                                <input type="file" id="example-fileinput" class="form-control-file" name="avatar" value="" required>
                                        ...
                                        <input type="submit" id="submit" value="Edit blog" class="btn btn-primary ">
                                    </form>
                                </div> <!-- /.card-body -->
                            </div> <!-- /.card -->
                        </div> <!-- /.col -->
